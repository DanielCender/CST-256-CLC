	...
	<div class="row">
		<div class="col-md-12"><!-- 12 row -->
			<div class="card">
				...
				<div class="card-body">
					<form action="/admin/user-update/{{ $user->ID }}" method="POST" ><!-- here we update the button-->
					{{ csrf_field() }}
					{{ method_field('PUT') }}
						...
						<div class="col-md-8"> <!--col-md-8 means 8 row and form put into one row and updtate the button below-->
							...
							<div class='form-group' style="text-align:left;">
								<div class="form-check form-switch">
									...
									<input class="form-check-input" name="suspended" type="checkbox" id="flexSwitchCheckDefault"
									 {{ $user->SUSPENDED == 1 ? 'checked' : '' }}
									 >
								</div>
							</div>
				     	<div class="form-group" style="text-align:left;">
